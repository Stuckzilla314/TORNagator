    ...
    <div style={{
      ...
      <div style={{
        ...
        {!isCapacitor && apiKey && userData && (
          ...
          >
            <button style={navItemStyle('dashboard')} onClick={() => setActiveTab('dashboard')} aria-pressed={activeTab === 'dashboard'}>Dashboard</button>
            <button style={navItemStyle('faction')} onClick={() => setActiveTab('faction')} aria-pressed={activeTab === 'faction'}>Faction War</button>
            <button style={navItemStyle('stock')} onClick={() => setActiveTab('stock')} aria-pressed={activeTab === 'stock'}>Overseas Stock</button>
            <button style={{ ...navItemStyle('torn'), display: 'flex', alignItems: 'center', gap: '6px' }} onClick={() => setActiveTab('torn')} aria-pressed={activeTab === 'torn'}><IconGamepad size={14} color={activeTab === 'torn' ? '#3498db' : '#888'} /> TORN</button>
            <button style={{ ...navItemStyle('apilogs'), display: 'flex', alignItems: 'center', gap: '6px' }} onClick={() => setActiveTab('apilogs')} aria-pressed={activeTab === 'apilogs'}>
        ...
        {isCapacitor && apiKey && userData && (
          ...
          >
            <button style={mobileNavItemStyle('dashboard')} onClick={() => setActiveTab('dashboard')} aria-pressed={activeTab === 'dashboard'}>
            ...
            <button style={mobileNavItemStyle('faction')} onClick={() => setActiveTab('faction')} aria-pressed={activeTab === 'faction'}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
              </svg>
              <span>Faction War</span>
            </button>
            <button style={mobileNavItemStyle('stock')} onClick={() => setActiveTab('stock')} aria-pressed={activeTab === 'stock'}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <button style={mobileNavItemStyle('torn')} onClick={() => setActiveTab('torn')} aria-pressed={activeTab === 'torn'}>
              <IconGamepad size={20} color={activeTab === 'torn' ? '#3498db' : '#777'} />
              <span>TORN</span>
            </button>
            <button style={mobileNavItemStyle('apilogs')} onClick={() => setActiveTab('apilogs')} aria-pressed={activeTab === 'apilogs'}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
                <line x1="8" y1="21" x2="16" y2="21" />
                <line x1="12" y1="17" x2="12" y2="21" />
