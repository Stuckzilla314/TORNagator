    ...
    >
      ...
      <div style={{
        ...
        {isCapacitor && apiKey && userData && (
          ...
          >
            <button style={mobileNavItemStyle('dashboard')} onClick={() => setActiveTab('dashboard')} aria-current={activeTab === 'dashboard' ? 'page' : undefined}>
            ...
            <button style={mobileNavItemStyle('faction')} onClick={() => setActiveTab('faction')} aria-current={activeTab === 'faction' ? 'page' : undefined}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
              <span>Faction War</span>
            </button>
            <button style={mobileNavItemStyle('stock')} onClick={() => setActiveTab('stock')} aria-current={activeTab === 'stock' ? 'page' : undefined}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <button style={mobileNavItemStyle('torn')} onClick={() => setActiveTab('torn')} aria-current={activeTab === 'torn' ? 'page' : undefined}>
              <IconGamepad size={20} color={activeTab === 'torn' ? '#3498db' : '#777'} />
              <span>TORN</span>
            </button>
            <button style={mobileNavItemStyle('apilogs')} onClick={() => setActiveTab('apilogs')} aria-current={activeTab === 'apilogs' ? 'page' : undefined}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <rect x="2" y="3" width="20" height="14" rx="2" ry="2" />
                <line x1="8" y1="21" x2="16" y2="21" />
                <line x1="12" y1="17" x2="12" y2="21" />
